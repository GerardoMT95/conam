...
declare var $: any;
@Component({
  selector: "pagamenti-riconcilia-manuale-pagamento-ordinanza-dettaglio",
  templateUrl:
    "./pagamenti-riconcilia-manuale-pagamento-ordinanza-dettaglio.component.html",
})
export class pagamentiRiconciliaManualePagamentoOrdinanzaDettaglioComponent
  ...
  ngOnInit(): void {
    this.logger.init(
      pagamentiRiconciliaManualePagamentoOrdinanzaDettaglioComponent.name
    );
