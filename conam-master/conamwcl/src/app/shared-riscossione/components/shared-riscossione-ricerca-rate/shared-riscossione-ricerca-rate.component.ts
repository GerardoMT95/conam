...
@Component({
  selector: "shared-riscossione-ricerca-rate",
  templateUrl: "./shared-riscossione-ricerca-rate.component.html",
  styleUrls: ["./shared-riscossione-ricerca-rate.component.scss"],
})
export class SharedRiscossioneRicercaRateComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    this.logger.init(SharedRiscossioneRicercaRateComponent.name);
  ...
  ngOnDestroy(): void {
    this.logger.destroy(SharedRiscossioneRicercaRateComponent.name);
  }
