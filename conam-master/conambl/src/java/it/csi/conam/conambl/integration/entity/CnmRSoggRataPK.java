...
/**
 * The primary key class for the cnm_r_sogg_rata database table.
 * 
 */
@Embeddable
public class CnmRSoggRataPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof CnmRSoggRataPK)) {
			return false;
		}
		CnmRSoggRataPK castOther = (CnmRSoggRataPK)other;
		return 
