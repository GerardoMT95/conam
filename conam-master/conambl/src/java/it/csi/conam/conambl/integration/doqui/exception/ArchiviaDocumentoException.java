...
////{PROTECTED REGION ID(R825240382) ENABLED START////}
/**
 * Inserire qui la documentazione dell'eccezione ArchiviaDocumentoException.
 * Consigli:
 * <ul>
...
public class ArchiviaDocumentoException extends UserException {
	 ...
	 * @generated
	 */
	public ArchiviaDocumentoException(String msg, String nestedExcClassName, String nestedExcMessage,
	 ...
	 * @generated
	 */
	public ArchiviaDocumentoException(String msg, Throwable nested) {
		super(msg, nested);
	}
	 ...
	 * @generated
	 */
	public ArchiviaDocumentoException(String msg) {
		super(msg);
	}
}
