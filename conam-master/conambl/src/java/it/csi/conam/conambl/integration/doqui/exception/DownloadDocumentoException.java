...
////{PROTECTED REGION ID(R2126965291) ENABLED START////}
/**
 * Inserire qui la documentazione dell'eccezione DownloadDocumentoException.
 * Consigli:
 * <ul>
...
public class DownloadDocumentoException extends UserException {
	 ...
	 * @generated
	 */
	public DownloadDocumentoException(String msg, String nestedExcClassName, String nestedExcMessage,
	 ...
	 * @generated
	 */
	public DownloadDocumentoException(String msg, Throwable nested) {
		super(msg, nested);
	}
	 ...
	 * @generated
	 */
	public DownloadDocumentoException(String msg) {
		super(msg);
	}
}
