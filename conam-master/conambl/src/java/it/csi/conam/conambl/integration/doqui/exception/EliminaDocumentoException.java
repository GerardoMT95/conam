...
////{PROTECTED REGION ID(R-296299196) ENABLED START////}
/**
 * Inserire qui la documentazione dell'eccezione EliminaDocumentoException.
 * Consigli:
 * <ul>
...
public class EliminaDocumentoException extends UserException {
	 ...
	 * @generated
	 */
	public EliminaDocumentoException(String msg, String nestedExcClassName, String nestedExcMessage,
	 ...
	 * @generated
	 */
	public EliminaDocumentoException(String msg, Throwable nested) {
		super(msg, nested);
	}
	 ...
	 * @generated
	 */
	public EliminaDocumentoException(String msg) {
		super(msg);
	}
}
