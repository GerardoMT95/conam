...
public class MetadatiAllegato implements java.io.Serializable {
	/**
	 * 
	 */
	private static final long serialVersionUID = 6189930650813574572L;
	...
	public MetadatiAllegato() {
	}

	public MetadatiAllegato(java.lang.String codiceFiscale, java.lang.String cognome, java.lang.String denominazione, java.lang.String idEntitaFruitore, java.lang.String nome,
	...
	/**
	 * Gets the codiceFiscale value for this MetadatiAllegato.
	 * 
	...
	/**
	 * Sets the codiceFiscale value for this MetadatiAllegato.
	 * 
	 * @param codiceFiscale
	 */
	...
	/**
	 * Gets the cognome value for this MetadatiAllegato.
	 * 
	 * @return cognome
	 */
	...
	/**
	 * Sets the cognome value for this MetadatiAllegato.
	 * 
	 * @param cognome
	 */
	...
	/**
	 * Gets the denominazione value for this MetadatiAllegato.
	 * 
	...
	/**
	 * Sets the denominazione value for this MetadatiAllegato.
	 * 
	 * @param denominazione
	 */
	...
	/**
	 * Gets the idEntitaFruitore value for this MetadatiAllegato.
	 * 
	...
	/**
	 * Sets the idEntitaFruitore value for this MetadatiAllegato.
	 * 
	...
	/**
	 * Gets the nome value for this MetadatiAllegato.
	 * 
	 * @return nome
	 */
	...
	/**
	 * Sets the nome value for this MetadatiAllegato.
	 * 
	 * @param nome
	 */
	...
	/**
	 * Gets the targa value for this MetadatiAllegato.
	 * 
	 * @return targa
	 */
	...
	/**
	 * Sets the targa value for this MetadatiAllegato.
	 * 
	 * @param targa
	 */
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof MetadatiAllegato))
			return false;
		MetadatiAllegato other = (MetadatiAllegato) obj;
		/*if (obj == null)
			return false;*/
		if (this == obj)
			return true;
		...
		_equals = true && ((this.codiceFiscale == null && other.getCodiceFiscale() == null) || (this.codiceFiscale != null && this.codiceFiscale.equals(other.getCodiceFiscale())))
				&& ((this.cognome == null && other.getCognome() == null) || (this.cognome != null && this.cognome.equals(other.getCognome())))
	...
	// Type metadata
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(MetadatiAllegato.class, true);

	static {
		typeDesc.setXmlType(new javax.xml.namespace.QName("urn:stadocStadoc", "MetadatiAllegato"));
	...
	public String toString() {
		return "MetadatiAllegato [codiceFiscale=" + codiceFiscale + ", cognome=" + cognome + ", denominazione=" + denominazione + ", idEntitaFruitore=" + idEntitaFruitore + ", nome=" + nome
				+ ", targa=" + targa + "]";
	}
