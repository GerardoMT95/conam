...
////{PROTECTED REGION ID(R-968246389) ENABLED START////}
/**
 * Inserire qui la documentazione dell'eccezione AggiungiAllegatoException.
 * Consigli:
 * <ul>
...
public class AggiungiAllegatoException extends UserException {
	 ...
	 * @generated
	 */
	public AggiungiAllegatoException(String msg, String nestedExcClassName, String nestedExcMessage,
	 ...
	 * @generated
	 */
	public AggiungiAllegatoException(String msg, Throwable nested) {
		super(msg, nested);
	}
	 ...
	 * @generated
	 */
	public AggiungiAllegatoException(String msg) {
		super(msg);
	}
}
